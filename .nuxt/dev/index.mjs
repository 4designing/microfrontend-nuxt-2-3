...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/apple/config-extends/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/apple/config-extends/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/apple/config-extends/node_modules/devalue/index.js';
import { renderSSRHead } from 'file:///Users/apple/config-extends/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/apple/config-extends/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/apple/config-extends/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/apple/config-extends/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/apple/config-extends/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/apple/config-extends/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/apple/config-extends/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/apple/config-extends/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/apple/config-extends/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/apple/config-extends/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/apple/config-extends/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/apple/config-extends/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/apple/config-extends/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/apple/config-extends/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/apple/config-extends/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/apple/config-extends/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/apple/config-extends/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/apple/config-extends","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/apple/config-extends/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/apple/config-extends/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/apple/config-extends/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/apple/config-extends/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _s3oL68VDiU = (function(nitro) {
...
const _tDznjBTQsu = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const _lazy_P0PlhT = () => Promise.resolve().then(function () { return hello$1; });
const _lazy_Rc1TYh = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/hello', handler: _lazy_P0PlhT, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Rc1TYh, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Rc1TYh, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/apple/config-extends/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
